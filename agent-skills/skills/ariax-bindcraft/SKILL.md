...
selected chains and include the binder in memory planning. Validate the current
GPU eligibility policy and use live hourly prices when choosing acceptable GPUs.
